...
[ApiController]
[Route("api/membros")]
public class MembrosController(IMembroRepository repository) : ControllerBase
{
  [HttpGet]
  ...
  [HttpPost]
  public async Task<IActionResult> Post([FromBody] Membro input)
  {
  ...
  [HttpPut("{id:guid}")]
  public async Task<IActionResult> Put(Guid id, [FromBody] Membro input)
  {

...
[ApiController]
[Route("api/tarefas")]
public class TarefasController(ITarefaRepository repository) : ControllerBase
{
  [HttpGet]
  ...
  [HttpPost]
  public async Task<IActionResult> Post([FromBody] TarefaDelegada input)
  {
  ...
  [HttpPut("{id:guid}")]
  public async Task<IActionResult> Put(Guid id, [FromBody] TarefaDelegada input)
  {
